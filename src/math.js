modules.math = '2023-December-14'; NaturalMath = {}; NaturalMath.getNumberFromString = function (string) {return (isNil(string) ? '0' : (isNil(string.toString) ? '0' : string.toString(
...
) : fromStart) : ((string[0] === '9') && (last === '0') ? '1' : '')) + last;}; NaturalMath.fixZerosOnNumber = function (string) {var i = 0, checker = [];
...
NaturalMath.addOne = function (string) {return NaturalMath.fixZerosOnNumber(NaturalMath.basicAddOne(string));}; NaturalMath.deleteOne = function (string) {
string = NaturalMath.getNumberFromString(string); return ((string === '0') ? string : NaturalMath.fixZerosOnNumber(NaturalMath.basicDeleteOne(string)));};
...
naturalNumber, isNegative) {this.naturalNumber = NaturalMath.fixZerosOnNumber(NaturalMath.getNumber(naturalNumber)); this.isNegative = asABool(isNegative);};
...
'ZOOM 0.5 SIZE' : 'pocket (0.5x)',
'ZOOM 0.75 SIZE' : 'little (0.75x)',
'ZOOM 0.9 SIZE' : 'legacy (0.9x)',
'ZOOM 1 SIZE' : 'normal (1x)',
'ZOOM 1.11 SIZE' : 'demo (1.11x)',
'ZOOM 1.295 SIZE' : 'presentation (1.295x)',
'ZOOM 1.365 SIZE' : 'master (1.365x)',
'ZOOM 1.445 SIZE' : 'moderator (1.445x)',
'ZOOM 1.5 SIZE' : 'studio (1.5x)',
'ZOOM 2 SIZE' : 'big (2x)',
'ZOOM 4 SIZE' : 'huge (4x)',
...
'SELECTOR turn INPUTS %n degrees' : 'turn right \( $turnRight-1 \) %n º',
'SELECTOR turnLeft INPUTS %n degrees' : 'turn left \( $turnLeft-1 \) %n º',
'SELECTOR setHeading INPUTS %dir' : 'point in direction %dir º',

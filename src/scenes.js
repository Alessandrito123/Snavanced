...
function Project (scenes, current) {var projectScene; this.scenes = (scenes || new List); this.currentScene = current; this.name = null; this.notes = null; this.thumbnail = null; projectScene = this.scenes.at(1);
if (projectScene) {this.name = projectScene.name; this.notes = projectScene.notes; this.thumbnail = normalizeCanvas(projectScene.stage.thumbnail(SnapSerializer.prototype.thumbnailSize));}; this.sceneIdx = null;
this.trash = [];}; Project.prototype.initialize = function anonymous () {this.currentScene = this.scenes.at(+this.sceneIdx || 1); return this;}; Project.prototype.addDefaultScene = function anonymous () {
var scene = new Scene; scene.addDefaultSprite(); this.scenes.add(scene);};

...
PaintEditorMorph.prototype._destroy = PaintEditorMorph.prototype.destroy;
PaintEditorMorph.prototype.destroy = function () {this.isDestroyed = true;
this._destroy();};

PaintEditorMorph.prototype.switchToVector = function () {
    this.object = new SVG_Costume(new Image, '', new Point(0,0));
    this.isReplaced = true;
    this.replacement = this.object.edit(
        this.world(),
        this.ide,
        true,
        nop,
...
PaintEditorMorph.prototype.populatePropertiesMenu = function () {
    ...
    pc.primaryColorViewer.render = function (ctx) {
        ...
        if (myself.paper.settings.linewidth > 0) {
        ctx.lineWidth = Math.max(Math.min(myself.paper.settings.linewidth, 20), 0);
        ctx.beginPath();
        ctx.lineCap = "round";
        ctx.moveTo(20, 30);
        ctx.lineTo(160, 30);
...
PaintCanvasMorph.prototype.rerender = PaintCanvasMorph.prototype.drawNew;
...
}; PaintCanvasMorph.prototype.drawRectBorder = InputFieldMorph.prototype.drawRectBorder; PaintCanvasMorph.prototype.edge = InputFieldMorph.prototype.edge; PaintCanvasMorph.prototype.fontSize =
InputFieldMorph.prototype.fontSize; PaintCanvasMorph.prototype.typeInPadding = InputFieldMorph.prototype.typeInPadding; PaintCanvasMorph.prototype.contrast = InputFieldMorph.prototype.contrast